...
# Create a matrix to plot the change in mean concenctrated disadvantage over time

conDis_mean_matrix <- matrix(nrow = 4, ncol = 2, c("1970","1980","1990","2000",conDis_70_mean,conDis_80_mean, conDis_90_mean,conDis_00_mean))
colnames(conDis_mean_matrix) <- c("Year", "Index")
conDis_mean_matrix

#Convert to dataframe for plotting

conDis_mean_df <- as.data.frame(conDis_mean_matrix)
conDis_mean_df
```
### Preliminary Analysis

From 1970 to 2000, the average geometric index of concentrated disadvantage nearly doubled, with the most dramatic increase being between the 1970 and 1980. While this shows that disadvantage increased in the city as a whole, it is necessary to analyse the spatial distribution of CD over time within the city as a precursour to the analysis of gentrification. I identify tracts succeptible to gentrification if during any time period, the tracts geometric index is greater than mean. While I use census tracts for the analysis, I also use neighborhood boundary files provided by the open data buffalo portal to distinguish neighborhoods in the report.
